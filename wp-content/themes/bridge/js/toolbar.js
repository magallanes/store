...
$j(document).ready(function() {
    ...
    if(window.location.href.indexOf("bridge/") > -1 || window.location.href.indexOf("bridge1000/") > -1){
        $j('#nav-menu-item-14859 .second .inner').prepend( "<div class='see_all'><div class='see_all_inner'><p>Bridge Theme comes with 64+ amazing easy-to-import demos</p><a href='http://demo.qodeinteractive.com/bridge/demos' class='qbutton green no_ajax'>See All Demos</a></div></div>" );
    }
